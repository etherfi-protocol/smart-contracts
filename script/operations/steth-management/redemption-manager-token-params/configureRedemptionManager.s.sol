 ...
 *         large stETH redemptions (e.g. whale weETH -> stETH).
 *
 ...
 *
 * Run:
 * forge script script/operations/steth-management/redemption-manager-token-params/configureRedemptionManager.s.sol --fork-url $MAINNET_RPC_URL -vvvv
 */
contract ConfigureRedemptionManagerForWhaleRedemption is Script, Utils, Test {
    ...
    function testWhaleEEthToStEthRedemption(address stETH) internal {
        ...
        // Complete pending EigenLayer queued withdrawals to fund restaker with stETH
