...
contract DeployNewNodeOperatorManagerScript is Script {
    ...
    function run() external {
        ...
        if(block.chainid == 1) {
            ...
            operators[0] = 0x99635FA608caaAC2b04720Cb875EA7075A4622d6;
            // operators[1] = 0xD0d7F8a5a86d8271ff87ff24145Cf40CEa9F7A39;

            hashes = new bytes[](1);
            totalKeys = new uint64[](1);
            keysUsed = new uint64[](1);
        }
        ...
        NodeOperatorManager(nodeOperatorManagerInstance).setAuctionContractAddress(AuctionManagerProxyAddress);
