...
contract DeployRestakingRewardsRouter is Script {
    ...
    address routerImpl;
    address routerProxy;
    bytes32 commitHashSalt = bytes32(bytes20(hex"0000000000000000000000000000000000000000"));
    ...
    function run() public {
        console2.log("================================================");
        console2.log("======== Running Deploy Restaking Rewards Router ========");
        console2.log("================================================");
        console2.log("");
        ...
        // Deploy RestakingRewardsRouter implementation
        {
            ...
            routerImpl = deployCreate2(contractName, constructorArgs, bytecode, commitHashSalt, true);
        }
        ...
        // Deploy UUPSProxy
        {
            ...
            routerProxy = deployCreate2(contractName, constructorArgs, bytecode, commitHashSalt, true);
        }
