...
contract DeployWeETHWithdrawAdapter is Script {
    ...
    // Commit hash salt
    bytes32 commitHashSalt = bytes32((hex"34e9e90c2cb654d5ed227ec1ed1507d1b8393496708a4db9a0c3ff34f1428a04")); // sha256sum src/LiquidRefer.sol 
    ...
    function verifyDeployment(LiquidRefer liquidRefer, address implementationAddress) internal view {
        ...
        require(address(liquidRefer.roleRegistry()) == roleRegistryAddress, "RoleRegistry address mismatch");
        ...
        require(liquidRefer.owner() == timelockAddress, "Owner should be timelock");
