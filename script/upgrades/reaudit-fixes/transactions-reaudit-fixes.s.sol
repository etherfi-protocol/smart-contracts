...
contract ReauditFixesTransactions is Utils {
    ...
    function verifyDeployedBytecode() public {
        ...
        WithdrawRequestNFT newWithdrawRequestNFTImplementation = new WithdrawRequestNFT(address(WITHDRAW_REQUEST_NFT_BUYBACK_SAFE), address(0x0), address(ETHERFI_ADMIN));
