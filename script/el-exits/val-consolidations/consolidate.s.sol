...
contract ConsolidateValidators is Script, Utils {
    ...
    function run() external {
        ...
        // Link validators at indices 0, 350, 650, 830 (1st, 351st, 651st, 831st)
    ...
    function _linkLegacyValidatorIds(uint256[] memory ids, bytes[] memory pubkeys) internal {
        // Link validators at indices 0, 350, 650, 830 (1st, 351st, 651st, 831st)
        uint256[4] memory indices = [uint256(0), 350, 650, 830];
        ...
        console2.log("Linking", legacyCount, "legacy validator IDs (indices 0, 350, 650, 830)...");
