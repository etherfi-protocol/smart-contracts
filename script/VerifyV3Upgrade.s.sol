...
contract VerifyV3Upgrade is Script {
    // Mainnet addresses from prelude.t.sol
    ...
    function verifyProxyUpgradeability(
        ...
        // 3. upgradeTo(address) selector exists and reaches _authorizeUpgrade
        //    (staticcall → no state‑change; we expect *either* success or revert,
        //     but NOT ‘selector not found’, which would return (false,""))
