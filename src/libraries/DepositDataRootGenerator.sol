...
library depositDataRootGenerator {
    ...
    function generateDepositDataRoot(bytes calldata pubkey, bytes calldata signature, bytes calldata withdrawal_credentials, uint256 _amountIn) public pure returns (bytes32) {
