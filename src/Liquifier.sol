...
contract Liquifier is Initializable, UUPSUpgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable, ILiquifier {
    ...
    bool public isDepositOfRestakedAssetAllowed;
    ...
    function initializeOnUpgrade(address _pancakeRouter) external onlyOwner {
        ...
        isDepositOfRestakedAssetAllowed = true;
    }
    ...
    function depositWithQueuedWithdrawal(IStrategyManager.QueuedWithdrawal calldata _queuedWithdrawal, address _referral) external whenNotPaused nonReentrant returns (uint256) {
        require(isDepositOfRestakedAssetAllowed, "NOT_ALLOWED");
    ...
    function allowDepositOfRestakedAsset(bool _allow) external onlyOwner {
        isDepositOfRestakedAssetAllowed = _allow;
    }
