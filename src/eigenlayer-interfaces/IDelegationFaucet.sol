...
interface IDelegationFaucet {
    function mintDepositAndDelegate(address _operator, IDelegationManager.SignatureWithExpiry memory approverSignatureAndExpiry, bytes32 approverSalt, uint256 _depositAmount) external;
