...
contract EtherFiOracleTest is TestSetup {
    ...
    // test_setEtherFiAdmin removed: setEtherFiAdmin was deleted from EtherFiOracle
    // (the storage slot is now written directly by TestSetup via vm.store).

    function test_updateAdmin() public {
        address newAdmin = address(0x1234);
        // ETHERFI_ORACLE_ADMIN_ROLE consolidated into OPERATION_TIMELOCK_ROLE.
        bytes32 oracleAdminRole = roleRegistryInstance.OPERATION_TIMELOCK_ROLE();
