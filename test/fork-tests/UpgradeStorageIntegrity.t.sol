...
contract UpgradeStorageIntegrityTest is Test, Deployed {
    ...
    function test_upgrade_preserves_all_sequential_storage() public {
        ...
        address newWRN = address(new WithdrawRequestNFT(WITHDRAW_REQUEST_NFT_BUYBACK_SAFE, EETH, LIQUIDITY_POOL, MEMBERSHIP_MANAGER, ROLE_REGISTRY, address(blacklisterInstance), 0, 4e18));
