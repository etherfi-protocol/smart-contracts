...
contract ContractCodeCheckerTest is TestSetup {
    ...
    function test_deployment_bytecode() public {
        ...
        EtherFiRestaker etherFiRestakerImplementation = new EtherFiRestaker(address(eigenLayerRewardsCoordinator), address(0x0), address(roleRegistryInstance), address(rateLimiterInstance));
