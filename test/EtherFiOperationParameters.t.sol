...
contract EtherFiOperationParametersTest is TestSetup {
    ...
    function testFuzz_updateTagAdmin(string calldata tag, address admin, bool allowed) public {
        operationParameters.updateTagAdmin(tag, admin, allowed);
        assertEq(operationParameters.tagAdmins(tag, admin), allowed);
    }

    function testFuzz_updateTagKeyValue(string calldata tag, string calldata key, string calldata value1, string calldata value2) public {
        vm.expectRevert();
    ...
    function testFuzz_updateTagAdmin_onlyOwner(string calldata tag, address admin, bool allowed) public {
    ...
    function testFuzz_updateTagKeyValue_onlyAdmin(string calldata tag, string calldata key, string calldata value) public {
    ...
    function testFuzz_updateTagKeyValue_asAdmin(string calldata tag, string calldata key, string calldata value1, string calldata value2) public {
