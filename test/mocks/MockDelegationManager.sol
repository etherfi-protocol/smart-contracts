...
contract MockDelegationManager is MockDelegationManagerBase, Test {
    ...
    function getWithdrawableShares(address staker, IStrategy[] memory strategies) external view override returns (uint256[] memory withdrawableShares, uint256[] memory depositShares) {
    ...
    //************************************************************
    function completeQueuedWithdrawals(Withdrawal[] calldata withdrawals, IERC20[][] calldata tokens, bool[] calldata receiveAsTokens) external override {
