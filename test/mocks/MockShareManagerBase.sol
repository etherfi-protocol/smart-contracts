...
contract MockShareManagerBase is IShareManager {
    ...
    function addShares(address staker, IStrategy strategy, uint256 shares) external virtual returns (uint256, uint256) {}
    ...
    function withdrawSharesAsTokens(address staker, IStrategy strategy, IERC20 token, uint256 shares) external virtual {}
     ...
     */
    function increaseBurnableShares(IStrategy strategy, uint256 addedSharesToBurn) external virtual {}
}
