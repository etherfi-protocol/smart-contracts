...
import "src/eigenlayer-libraries/Merkle.sol";

import "test/eigenlayer-mocks/integration/mocks/EIP_4788_Oracle_Mock.t.sol";
import "test/eigenlayer-utils/Logger.t.sol";
...
contract BeaconChainMock is Logger {
    ...
    function initialize_beaconchain_mock(uint64 _genesisTime) public {
